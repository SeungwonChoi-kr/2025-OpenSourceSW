...
### flask_server/flask_start.sh //간단하게 플라스크 서버 5001 포트부터 5005 포트로 5개 켜는 쉘스크립트
### flask_server/flask_stop.sh // 간단하게 켜진 플라스크 서버 5개 끄는 쉘스크립트(start.sh 로 켜진 서버 끄는용), 반드시 start 하면 stop 해줄 것.
